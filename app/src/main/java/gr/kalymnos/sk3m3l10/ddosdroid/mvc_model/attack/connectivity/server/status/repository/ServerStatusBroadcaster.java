...
import gr.kalymnos.sk3m3l10.ddosdroid.mvc_model.attack.connectivity.server.status.ServerStatus;
...
public class ServerStatusBroadcaster {
    ...
    public static void broadcastStatus(ServerStatus status, LocalBroadcastManager manager) {
